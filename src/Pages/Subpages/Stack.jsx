        ...
        <>
            <div className="container guide-container">
                ...
                <div className="content-area">
                    ...
                    <ul>
                        <a href="#Stack-Array_representation"><li>Stack-Array_representation</li></a>
                        <a href="#Stack-Linked_List_Representation"><li>Stack-Linked_List_Representation</li></a>
                    </ul>
                    <hr />

                    <h2 id='Stack-Array_representation'>Stack-Array_representation</h2>
                    ...
                    <h2 id='Stack-Linked_List_Representation'>Stack-Linked_list_Representation</h2>
